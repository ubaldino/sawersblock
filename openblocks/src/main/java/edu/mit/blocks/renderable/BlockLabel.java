...
public class BlockLabel implements MouseListener, MouseMotionListener, KeyListener {
    ...
    public final static Font blockFontSmall_Bold = new Font("Roboto", Font.BOLD, 9);
    public final static Font blockFontMedium_Bold = new Font("Roboto", Font.BOLD, 11);
    public final static Font blockFontLarge_Bold = new Font("Roboto", Font.BOLD, 13);
    public final static Font blockFontSmall_Plain = new Font("Roboto", Font.PLAIN, 9);
    public final static Font blockFontMedium_Plain = new Font("Roboto", Font.PLAIN, 11);
    public final static Font blockFontLarge_Plain = new Font("Roboto", Font.PLAIN, 13);
