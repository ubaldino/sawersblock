...
public class DerechaBlock extends TranslatorBlock {

  public DerechaBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label) {
